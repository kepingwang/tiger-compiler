...
fun yyAction25 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        ( (* int literal, no + -. Size limit (32 bit)? *)
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ69(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ64(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction43(strm, yyNO_MATCH)
                  else yyQ106(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ64(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ43 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction8(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ110(strm', yyMATCH(strm, yyAction8, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ109(strm', yyMATCH(strm, yyAction8, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"#"
              ...
              then if inp = #" "
                  ...
                  then yyAction46(strm, yyNO_MATCH)
                  else yyQ20(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp = #"\\"
              then yyAction46(strm, yyNO_MATCH)
              else yyQ20(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
      (* end case *))
